...
Observed locally after this extension: mechanical checks, strict types, eight tests (85 assertions), the public-input guard, standalone build and native macOS arm64 smoke passed. Other native platforms and browser flows remain unexecuted.
